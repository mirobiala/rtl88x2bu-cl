# rtl88x2bu package for OpenWRT (v22.03.6)
...
I tested it with [TP-Link Archer T3U Nano](https://www.tp-link.com/us/home-networking/usb-adapter/archer-t3u-nano/) and [OpenWRT v22.03.6](https://openwrt.org/releases/22.03/notes-22.03.6).
...
git branch -a
git tag
git checkout openwrt-22.03.6
cd ../../../
```
* Download the default config for the **desired** target:
```
wget https://downloads.openwrt.org/releases/22.03.6/targets/<target>/config.buildinfo -O .config
```
