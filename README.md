# rtl88x2bu package for OpenWRT (v24.10.2)
...
I tested it with [TP-Link Archer T3U Nano](https://www.tp-link.com/us/home-networking/usb-adapter/archer-t3u-nano/) and [OpenWRT v24.10.2](https://openwrt.org/releases/24.10/notes-24.10.2).
...
git branch -a
git tag
git checkout openwrt-24.10.2
cd ../../../
```
* Download the default config for the **desired** target:
```
wget https://downloads.openwrt.org/releases/24.10.2/targets/<target>/config.buildinfo -O .config
```
