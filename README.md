# rtl88x2bu package for OpenWRT (v25.12.1)
...
I tested it with [TP-Link Archer T3U Nano](https://www.tp-link.com/us/home-networking/usb-adapter/archer-t3u-nano/) and [OpenWRT v25.12.1](https://openwrt.org/releases/25.12/notes-25.12.1).
...
git branch -a
git tag
git checkout openwrt-25.12.1
cd ../../../
```
* Download the default config for the **desired** target:
```
wget https://downloads.openwrt.org/releases/25.12.1/targets/<target>/config.buildinfo -O .config
```
