# rtl88x2bu package for OpenWRT (v19.07.10)
...
I tested it with [TP-Link Archer T3U Nano](https://www.tp-link.com/us/home-networking/usb-adapter/archer-t3u-nano/) and [OpenWRT v19.07.10](https://openwrt.org/releases/19.07/notes-19.07.10).
...
git branch -a
git tag
git checkout openwrt-19.07.10
cd ../../../
```
* Download the default config for the **desired** target:
```
wget https://downloads.openwrt.org/releases/19.07.10/targets/<target>/config.buildinfo -O .config
```
