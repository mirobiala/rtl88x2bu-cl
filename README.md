# rtl88x2bu package for OpenWRT (v22.03.7)
...
I tested it with [TP-Link Archer T3U Nano](https://www.tp-link.com/us/home-networking/usb-adapter/archer-t3u-nano/) and [OpenWRT v22.03.7](https://openwrt.org/releases/22.03/notes-22.03.7).
...
git branch -a
git tag
git checkout openwrt-22.03.7
cd ../../../
```
* Download the default config for the **desired** target:
```
wget https://downloads.openwrt.org/releases/22.03.7/targets/<target>/config.buildinfo -O .config
```
